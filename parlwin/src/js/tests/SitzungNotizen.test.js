...
function mount(notizen = []) {
  return shallowMount(SitzungNotizen, {
...
describe('SitzungNotizen — WYSIWYG-Eingabefeld', () => {
...
describe('SitzungNotizen — Autosave bei Blur', () => {
...
describe('SitzungNotizen — Debounce (5s)', () => {
...
describe('SitzungNotizen — Bearbeiten', () => {
