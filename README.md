...
- `PARLWIN_REALTIME_PORT` (Default: `29825`)
- `PARLWIN_REALTIME_WS_URL` (Default: `ws://localhost:29825/ws`)
...
Standard-Realtime-Port lokal: `29825` (anpassbar über `PARLWIN_REALTIME_PORT`).
