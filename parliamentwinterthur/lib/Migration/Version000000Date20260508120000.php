...
/**
 * Erstmalige Erstellung aller Datenbanktabellen für das Parliament Winterthur Tool.
 *
 * Tabellen:
...
class Version000000Date20260508120000 extends SimpleMigrationStep {
    ...
    private function erstelleGeschaefte(ISchemaWrapper $schema): void {
        ...
        $table->addColumn('titel', Types::STRING, ['notnull' => false, 'length' => 1000, 'default' => '']);
        ...
        $table->addColumn('roh_daten', Types::TEXT, ['notnull' => false, 'default' => '{}']);
